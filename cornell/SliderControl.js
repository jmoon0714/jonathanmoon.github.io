L.Control.SliderControl = L.Control.extend({
  ...
  startSlider: function () {
      ...
      slide: function (e, ui) {
        ...
        if (!!_options.markers[ui.value]) {
          ...
          if (_options.range) {
            ...
            var currentTime;
            if (_options.markers[ui.value].feature !== undefined) {
              currentTime = _options.markers[ui.value].feature.properties.opened;
            } else {
              currentTime = _options.markers[ui.value].options.opened;
            }
            for (i = _options.minValue; i <= _options.maxValue; i++) {
    ...
    if (!_options.range && _options.alwaysShowDate) {
      $('#slider-timestamp').html(_extractTimeStamp(_options.markers[index_start].feature.properties[_options.opened], _options));
    }
